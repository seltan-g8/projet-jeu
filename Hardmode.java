...
public class Hardmode {
    public static void main(String[] args) {
        ...
        while (!perdu) {
            ...
            commencerpartie(personnages, scanner, joueur,niveau ,experience,perdu);

            System.out.println("Lancement de la prochaine partie en cour ...");
        }

        System.out.println("Session terminée !");
        System.out.println("vouz avez atteint le niveau " + niveau + " !");
        System.out.println("vous avez gangé " + compteurparties + " parties de suite !");
...
static void commencerpartie(ArrayList<Personnage> personnages,Scanner scanner,Personnage joueur,
                            int niveau,int experience,boolean perdu){
...
static void decisionjoueur(ArrayList<Personnage>personnages,Scanner scanner,Personnage joueur){
    ...
    int cible = personnages.size();
    Personnage p = joueur;

    while (personnages.size()-1 < cible || cible < 0){
